        ...
        <div>
          <h1>About Us</h1>
            <Container>
              <Row>
                <Col xs={6} md={4}>
                  <img src={Matt} height="150 px" width="150 px" style={{'borderRadius':'5px'}} />
                  <h5>Matt Au</h5>
                ...
                <Col xs={6} md={4}>
                  <img src={Joel} height="150px" width="150px" style={{'borderRadius':'5px'}} />
                  <h5>Joel Magsalin</h5>
                ...
                <Col xs={6} md={4}>
                  <img src={Gina} height="150px" width="150px" style={{'borderRadius':'5px'}} />
                ...
                <Col xs={6} md={4}>
                  <img src={Mike} height="150px" width="150px" style={{'borderRadius':'5px'}} />
                  <h5>Mike Acio</h5>
                ...
                <Col xs={6} md={4}>
                  <img src={Sunil} height="150px" width="150px" style={{'borderRadius':'5px'}} />
