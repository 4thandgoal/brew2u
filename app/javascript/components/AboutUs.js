        ...
        <div>
          <h1>About Us</h1>
            <Container>
              <Row>
                <Col xs={6} md={4}>
                  <img src="/assets/images/headshots/joelMagsalin.jpg" rounded />
                  <h5>Matt Au</h5>
                  <p>After a top secret Super-Soldier program transformed frail Steve Rogers (Chris Evans) into the powerful and heroic Captain America, his amazing WWII exploits made him a living legend. Steve saved New York City and turned the tide of the war, but crashed into the Arctic during his final mission. Awakening in the modern day, Steve learned that he had spent decades frozen in the icy tundra. Now, Steve Rogers finds himself alone in a modern world that he hardly recognizes. When Nick Fury, director of the international peacekeeping agency S.H.I.E.L.D.</p>
                </Col>
                <Col xs={6} md={4}>
                  <img src="/assets/images/headshots/joelMagsalin.jpg" rounded />
                  <h5>Joel Magsalin</h5>
